...
export const newCountryWords: string =
`
...
export const SONGS: Song[] = [
    { id: 1, name: 'new country', artist: { id: 1, firstName: 'Shlomo', lastName: 'Artzi', country: 'Israel' }, 
    publisher: 'Artzi', words: newCountryWords, album: 'New country', genere: 'BLABLA', publicationYear: 1999}
];
